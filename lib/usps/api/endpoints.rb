...
require_relative 'endpoints/carrier_pickup_availability'
require_relative 'endpoints/carrier_pickup_cancel'
require_relative 'endpoints/carrier_pickup_change'
require_relative 'endpoints/carrier_pickup_inquiry'
...
module Usps
  module Api
    module Endpoints
      include CarrierPickupAvailability
      include CarrierPickupCancel
      include CarrierPickupChange
      include CarrierPickupInquiry
      ...
      ACTIONS = {
        carrier_pickup_availability: 'CarrierPickupAvailability',
        carrier_pickup_cancel: 'CarrierPickupCancel',
        carrier_pickup_change: 'CarrierPickupChange',
        carrier_pickup_inquiry: 'CarrierPickupInquiry',
